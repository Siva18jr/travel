...
class TermsActivity extends StatefulWidget {
  const TermsActivity({super.key});

  @override
  State<TermsActivity> createState() => _TermsActivityState();
}

class _TermsActivityState extends State<TermsActivity> {
